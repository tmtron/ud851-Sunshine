...
//  DONE (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIFICATION_ID = 1412;
...
//          DONE (3) Create an Intent with the proper URI to start the DetailActivity
            final Intent intentDetailActivity = new Intent(context, DetailActivity.class);
...
//          DONE (4) Use TaskStackBuilder to create the proper PendingIntent
            final PendingIntent pendingIntent = TaskStackBuilder.create(context)
                    .addNextIntentWithParentStack(intentDetailActivity)
                    // DONE MTR: what does requestCode 0 mean?
