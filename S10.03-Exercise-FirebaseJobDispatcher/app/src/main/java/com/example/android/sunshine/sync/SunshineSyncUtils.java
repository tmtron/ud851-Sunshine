...
//  DONE (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    // DONE MTR solution uses only a third of the sync time
...
//  DONE (12) Create a method to schedule our periodic weather sync
    private static void scheduleSyncJob(Context context) {
        ...
        final FirebaseJobDispatcher firebaseJobDispatcher = new FirebaseJobDispatcher(googlePlayDriver);
        final Job job = firebaseJobDispatcher.newJobBuilder()
